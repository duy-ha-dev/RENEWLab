...
filename = os.path.join(sys.path[0], 'pole_exp_1/twenty_yard/h5/first.hdf5') #This creates absolute path independent of system
...
# =============================================================================
            ...
            raw_samps_.to_csv(os.path.join(sys.path[0],'pole_exp_1_clean/twenty_yard/h5/samps_complex_first.csv'),index=False)
